    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap gap-3">
          <span className="text-xs px-3 py-1.5 bg-[#e5e5e5] text-[#363636] rounded-full">Înainte</span>
          <span className="text-xs px-3 py-1.5 bg-[#cca43b]/20 text-[#cca43b] rounded-full">Pe Parcurs</span>
          <span className="text-xs px-3 py-1.5 bg-[#242f40] text-white rounded-full">Rezultat Final</span>
        </div>
      </div>
