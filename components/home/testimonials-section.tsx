...
const testimonials = [
  {
    ...
    location: "Timișoara",
    rating: 5,
    text: "Am colaborat cu Loli Construct pentru înlocuirea completă a acoperișului casei mele. Profesionalismul echipei m-a impresionat de la prima întâlnire. Lucrarea a fost finalizată în termenul promis, iar calitatea este excepțională. Recomand cu încredere!",
  ...
  },
  {
    ...
    location: "Lugoj",
    rating: 5,
    text: "După mai multe infiltrații în acoperiș, am apelat la Loli Construct. Au identificat rapid problema și au reparat totul într-o singură zi. Sunt foarte mulțumită de rapiditatea și calitatea serviciilor. Prețuri corecte și transparente.",
  ...
  },
  {
    ...
    location: "Arad",
    rating: 5,
    text: "Am ales Loli Construct pentru construcția acoperișului halei mele industriale. Experiența lor în Germania se vede în fiecare detaliu. Structura este solidă, iar finisajele impecabile. Partenerul ideal pentru proiecte de anvergură.",
  ...
  },
  {
    ...
    location: "Deva",
    rating: 5,
    text: "Mansardarea casei a fost un vis devenit realitate datorită echipei Loli Construct. Au transformat podul într-un spațiu locuibil superb. Dulgheria este de o calitate rară în România. Mulțumim pentru profesionalism!",
