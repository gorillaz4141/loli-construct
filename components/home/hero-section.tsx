    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20">
      ...
      <div className="absolute inset-0 z-0">
        <div
          ...
          style={{
            backgroundImage: "url('/reno-acop-33.jpeg')",
          }}
        />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-[#e5e5e5] leading-relaxed max-w-xl">
              Montaj, reparații și întreținere acoperișuri cu standarde germane
              de excelență. Echipă profesionistă cu experiență în proiecte
          ...
          <div
            className={`hidden lg:block ${
              isVisible ? "animate-slide-in-right stagger-3" : "opacity-0"
            }`}
          >
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="mt-6 pt-6 border-t border-white/20 text-center">
                <p className="text-white/60 text-sm">
                  Deservim Timișoara și 100km rază
                </p>
              </div>
            </div>
          </div>
