...
const features = [
  { icon: Shield, text: "Garanție Extinsă" },
  { icon: Award, text: "Standarde Germane" },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-8 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-[#cca43b]/30 rounded-full px-4 py-2">
              ...
              <span className="text-[#cca43b] text-sm font-medium">Experiență Germania & Austria</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-[#e5e5e5] leading-relaxed max-w-xl">
              Montaj, reparații și întreținere acoperișuri cu standarde germane de excelență. Echipă profesionistă cu
              experiență în proiecte rezidențiale și industriale.
            </p>
          ...
          <div className={`hidden lg:block ${isVisible ? "animate-slide-in-right stagger-3" : "opacity-0"}`}>
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-4">
                  <p className="text-4xl font-serif font-bold text-[#cca43b]">15+</p>
                  <p className="text-white/80 text-sm mt-1">Ani Experiență</p>
                </div>
                <div className="text-center p-4">
                  <p className="text-4xl font-serif font-bold text-[#cca43b]">500+</p>
                  <p className="text-white/80 text-sm mt-1">Proiecte Finalizate</p>
                </div>
                <div className="text-center p-4">
                  <p className="text-4xl font-serif font-bold text-[#cca43b]">100%</p>
                  <p className="text-white/80 text-sm mt-1">Clienți Mulțumiți</p>
                </div>
                <div className="text-center p-4">
                  <p className="text-4xl font-serif font-bold text-[#cca43b]">24/7</p>
                  <p className="text-white/80 text-sm mt-1">Disponibilitate</p>
                </div>
              </div>
              <div className="mt-6 pt-6 border-t border-white/20 text-center">
                <p className="text-white/60 text-sm">Deservim Timișoara și 100km rază</p>
              </div>
            </div>
          </div>
        </div>
