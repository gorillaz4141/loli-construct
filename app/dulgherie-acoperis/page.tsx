...
const features = [
  ...
  },
  {
    ...
    description:
      "Aplicăm tratamente ignifuge și împotriva dăunătorilor. Protejăm investiția dvs. pe termen lung.",
  },
  {
...
const process = [
  {
    ...
    title: "Măsurători",
    description:
      "Realizăm măsurători precise și analizăm cerințele structurale ale proiectului.",
  },
  {
    step: 2,
    title: "Proiectare",
    description:
      "Elaborăm planurile detaliate cu calcule de rezistență și liste de materiale.",
  },
  {
    step: 3,
    title: "Prefabricare",
    description:
      "Pregătim elementele în atelier pentru montaj rapid și precis pe șantier.",
  },
  {
    step: 4,
    title: "Montaj",
    description:
      "Asamblăm structura pe șantier cu atenție la fiecare detaliu și îmbinare.",
  },
];
...
const materials = [
  {
    name: "Lemn de Brad",
    description:
      "Lemn de brad uscat la umiditate optimă, ideal pentru căpriori și grinzi secundare.",
  },
  {
    name: "Lemn de Molid",
    description:
      "Molid de calitate superioară pentru grinzi principale și structuri portante.",
  },
  {
    name: "Lemn Stratificat",
    description:
      "Grinzi din lemn lamelar încleiat pentru deschideri mari și solicitări speciale.",
  },
  {
    name: "Conectori Metalici",
    description:
      "Plăcuțe și conectori de îmbinare de la producători europeni de renume.",
  },
  {
    name: "Tratamente",
    description:
      "Soluții ignifuge și fungicide pentru protecția completă a lemnului.",
  },
  {
    name: "OSB și Astriș",
    description:
      "Plăci OSB și scândură pentru astriș de la producători certificați.",
  },
];
