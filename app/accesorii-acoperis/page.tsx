...
export const metadata: Metadata = {
  title: "Accesorii Acoperiș Timișoara - Jgheaburi, Burlane, Ferestre | Loli Construct",
  description:
...
const features = [
  ...
  {
    title: "Streașină",
    description: "Sisteme de streașină din PVC sau aluminiu. Protecție și ventilație pentru structura acoperișului.",
  },
  {
  ...
  {
    title: "Paratrăsnete",
    description: "Instalăm sisteme de protecție împotriva descărcărilor electrice, conform normativelor în vigoare.",
  },
]
...
const process = [
  {
    step: 1,
    title: "Evaluare",
    description: "Analizăm acoperișul existent și identificăm accesoriile necesare.",
  },
  {
    step: 2,
    title: "Selecție",
    description: "Vă ajutăm să alegeți produsele potrivite din gama noastră variată.",
  },
  {
    step: 3,
    title: "Comandă",
    description: "Comandăm produsele și programăm montajul la o dată convenabilă.",
  },
  {
    step: 4,
    title: "Montaj",
    description: "Instalăm profesional toate accesoriile și verificăm funcționarea.",
  },
]
...
const materials = [
  {
    ...
    description: "Sistem pluvial suedez din oțel, rezistent la coroziune și cu estetică premium.",
  },
  {
    name: "Ferestre Velux",
    description: "Ferestre de mansardă daneze, lider mondial în iluminare naturală și ventilație.",
  },
  {
    name: "Ferestre Fakro",
    description: "Alternative de calitate pentru ferestre de mansardă, cu diverse opțiuni de deschidere.",
  },
  {
    name: "Sistem Zambelli",
    description: "Jgheaburi și burlane din cupru sau zinc-titan pentru un aspect elegant și durabil.",
  },
  {
    name: "Coamă Ventilată",
    description: "Sisteme de coamă cu ventilație integrată pentru un acoperiș sănătos.",
  },
  {
    name: "Scări Acces",
    description: "Scări pliabile și fixe pentru acces la mansardă și pe acoperiș.",
  },
]
